    ...
    class Program
    {
        static void Main(string[] args)
        {
...

            {
                ...
                //TODO
                List<string> str = new List<string> { "12345", "1234", "123", "12" };
                int charcount = str.Sum((x) => x.Length);
            }

            {
                ...
                //TODO
                List<string> str = new List<string> { "12345", "1234", "123", "12" };
                var res = str.Select(x => x.Substring(0, 1)).ToArray().Aggregate((x, y) => x + y);
...

            {
                ...
                int k = 5;
                IEnumerable<int> n = new int[] { 12, 88, 1, 88, 3, 5, 4, 6, 6, 2, 5, 8, 9, 0, 90 };
...

            {
                ...
                //TODO
                int k = 5;
                List<string> str = new List<string> { "12345", "12L34", "123", "12", "1234K", "L1234" };
                var res = str.Where(x => (char.IsDigit(x[x.Length - 1])) && (x.Length == k)).ToArray();
                /*      for (int i=0; i<res.Length; i++)
                      {
                          Console.WriteLine(res[i]);
                      }
...

            {
                ...
                int d = 5;
                int k = 20;
                var result29 = n.OrderBy(w => w).TakeWhile(x =>x < d).Union(n.Skip(k)).OrderByDescending(o => o);
            }
...

            {
                ...
                //TODO
                List<string> str = new List<string> { "12345", "12L34", "123", "12", "12345K", "L123456" };
                var result36 = str.Where(u => u.Length % 2 != 0).Select(x => x[0])
                    .Concat(str.Where(u => u.Length % 2 == 0).Select(x => x[x.Length - 1])).ToArray()
                    .OrderByDescending(c => Convert.ToInt32(c));
            }

            {
                ...
                int K1 = 5;
                int K2 = 10;
                IEnumerable<int> n = new int[] { 12, 88, 1, 3, 5, 9, 6, 6, 2, 5, 8, 9, 0, 90 };
                var res = n.Where(x => (x > K1 && x < K2)).Select(x => x.ToString()).OrderBy(x => x).ToArray();
            }
            {
